...
app.post('/api/data', (req, res) => {
  ...
  const moscowDate = currentDate.toLocaleString('en-US', options);
   ...
   const OrdersData = fs.readFileSync('/root/expre/express/orders.txt', 'utf8');
...
console.log(Data)
fs.appendFileSync('/root/expre/express/orders.txt', Data);
...
const OrdersData = fs.readFileSync('/root/expre/express/orders.txt', "utf-8")
...
console.log(newData)
fs.writeFileSync('/root/expre/express/orders.txt', newData);
